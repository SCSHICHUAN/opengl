...
//        }
        ...
        lightPos = glm::vec3(x*0.6, y*0.7, z);
        ...
        lightingShader.setFloat("light.cutOff", glm::cos(glm::radians(5.0f)));//切光角
        lightingShader.setFloat("light.outerCutOff", glm::cos(glm::radians(6.f)));//外切光角
